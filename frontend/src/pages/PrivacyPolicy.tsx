      ...
      <div className="card-f1 p-8">
        ...
        <div className="space-y-6 text-f1-gray">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-f1-yellow-500 mb-2">2.1 Personal Information</h3>
            ...
            <h3 className="text-xl font-semibold text-f1-yellow-500 mt-4 mb-2">2.2 Automatically Collected Information</h3>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-f1-yellow-500 mb-2">4.1 Google AdSense</h3>
            <p className="mb-3">
            ...
            <h3 className="text-xl font-semibold text-f1-yellow-500 mb-2">4.2 External APIs</h3>
            ...
            <h3 className="text-xl font-semibold text-f1-yellow-500 mb-2">4.3 Email Service</h3>
            <p>
